...
This repo contains the ftops API (Cloudflare Worker + D1) and UI (Vite/React on Cloudflare Pages), plus shared infrastructure as code.

## Repo layout

- `apps/api` - Cloudflare Worker API, D1 migrations, queues
- `apps/ui` - Vite/React UI deployed to Cloudflare Pages
...
- `CLOUDFLARE_API_TOKEN` - token with Workers, Pages, and Zero Trust Access permissions
