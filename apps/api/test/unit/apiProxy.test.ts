...
describe("ops api proxy allowlist", () => {
  ...
  it.each([
    ...
    ["GET", "/api/customers/customer_1/contacts/contact_1"],
    ["DELETE", "/api/customers/customer_1/contacts/contact_1"],
    ["PATCH", "/api/customers/customer_1/addresses/address_1"],
    ["POST", "/api/customers/customer_1/opportunities"],
    ...
    ["GET", "/api/customer-files/file_1/preview"],
