...
const ALLOWLIST: AllowlistEntry[] = [
  ...
  { methods: new Set(["GET"]), pattern: /^\/customers\/[^/]+\/quickbooks\/search$/ },
  {
    methods: new Set(["POST"]),
    pattern: /^\/customers\/[^/]+\/quickbooks\/(?:link|create|refresh|retry)$/,
  },
  { methods: new Set(["GET"]), pattern: /^\/tasks\/kanban$/ },
  { methods: new Set(["GET", "PATCH"]), pattern: /^\/tasks\/[^/]+$/ },
  { methods: new Set(["GET", "POST"]), pattern: /^\/tasks\/[^/]+\/notes$/ },
  { methods: new Set(["GET"]), pattern: /^\/tasks\/[^/]+\/files$/ },
  { methods: new Set(["PUT"]), pattern: /^\/tasks\/[^/]+\/files\/upload$/ },
  { methods: new Set(["POST"]), pattern: /^\/tasks\/[^/]+\/files\/init$/ },
  { methods: new Set(["POST"]), pattern: /^\/tasks\/[^/]+\/files\/complete$/ },
  { methods: new Set(["GET"]), pattern: /^\/task-files\/[^/]+\/download$/ },
  { methods: new Set(["DELETE"]), pattern: /^\/task-files\/[^/]+$/ },
  { methods: new Set(["GET", "POST"]), pattern: /^\/workspaces$/ },
  { methods: new Set(["GET", "PATCH", "DELETE"]), pattern: /^\/workspaces\/[^/]+$/ },
  { methods: new Set(["GET"]), pattern: /^\/workspaces\/[^/]+\/users$/ },
  { methods: new Set(["POST"]), pattern: /^\/workspaces\/[^/]+\/users$/ },
  { methods: new Set(["PATCH", "DELETE"]), pattern: /^\/workspaces\/[^/]+\/users\/[^/]+$/ },
  {
    methods: new Set(["POST"]),
    pattern: /^\/workspaces\/[^/]+\/users\/[^/]+\/daily-summary$/,
  },
  ...
  { methods: new Set(["POST"]), pattern: /^\/integrations\/[^/]+\/sync$/ },
  ...
  { methods: new Set(["GET"]), pattern: /^\/preferences$/ },
  { methods: new Set(["PUT"]), pattern: /^\/preferences\/[^/]+$/ },
];
