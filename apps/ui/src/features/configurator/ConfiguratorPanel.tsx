      ...
      {report && totals && (
        <>
          ...
          <p className={stylex(styles.coverage)}>
            ...
            Visits represent sessions, not unique people. Earlier shares, price requests, and leads
            are included when available. *Email acceptance does not confirm inbox delivery.
          </p>
